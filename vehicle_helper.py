...
class VehicleHelper:
    ...
    def __init__(self, port=5556, dt=0.1):
        ...
        self.heartbeat = 0
        self.vehicle_information = pb.VehicleInformation()
        ...
        self.vehicle_information.batt_voltage = 13.0
        self.vehicle_information.batt_current = 0
        self.vehicle_information.batt_percent = 100
    ...
    def update_data(self):
        ...
        self.vehicle_information.batt_current = 0.0
        ...
        for i in range(3):
            ...
            self.vehicle_information.batt_voltage -= (
                self.velocity[i] / 1000.0
            )  # these are pointless magic numbers
            self.vehicle_information.batt_current += self.velocity[i] / 10.0
        ...
        self.vehicle_information.batt_percent = (
            self.vehicle_information.batt_voltage / 12.0
        )
